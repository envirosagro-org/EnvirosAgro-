                    ...
                    <div className="relative z-10">
                       ...
                       <div className="bg-earth-50 dark:bg-earth-900 p-6 rounded-2xl mb-8 border border-black/5 shadow-inner">
                          <div className="flex justify-between items-center mb-2">
                             ...
                             <span className="text-xl font-serif font-black text-agro-600">500 TKZ</span>
                          </div>
                          <p className="text-[8px] font-bold text-earth-400 uppercase text-center tracking-widest">Approx. $520.00 USD</p>
                       </div>
