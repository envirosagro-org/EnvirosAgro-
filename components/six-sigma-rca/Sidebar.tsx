  ...
  <aside className="lg:col-span-4 space-y-8">
    <div className="ea-card p-10 bg-blue-600 text-white shadow-xl relative overflow-hidden group">
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm font-medium leading-relaxed mb-10 opacity-80">
          The EnvirosAgro network is operating at Six Sigma reliability. This equates to fewer than 3.4 defects per million boot opportunities.
        </p>
        <button className="w-full bg-white text-blue-700 font-black py-4 rounded-2xl text-[10px] uppercase tracking-widest shadow-xl active:scale-95 transition-all">
          Download Audit PDF
        </button>
      </div>
    </div>
