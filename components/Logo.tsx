 ...
 * 
 * Evolution 3.0: 
 * - Standardized 15° chamfers across all geometric glyphs.
 * - Balanced stroke weights for cross-platform legibility.
 * - Integrated Material-Agro gradient support.
 */
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const getViewBox = () => {
    switch(variant) {
      ...
      case 'horizontal': return "0 0 1350 250";
  ...
  const getWidth = () => {
    ...
    if (variant === 'horizontal') return size * 5.4;
      ...
      >
        <defs>
          <linearGradient id={`grad-${uniqueId}`} x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#15803d" /> {/* Agro-700 */}
        ...
        {variant === 'horizontal' && (
          <>
            ...
            <g transform="translate(260, 48) scale(0.9)">
              {WordmarkPaths}
            </g>
          </>
        )}
